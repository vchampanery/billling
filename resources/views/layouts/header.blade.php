...
<!--      <li class="nav-item d-none d-sm-inline-block">
      ...
      @can('user-dashboard')
       <li class="nav-item d-none d-sm-inline-block">
          <a class="nav-link" href="{{ route('userdashboard.show') }}">Home</a>
      </li>
      @endcan
      @can('client-list')
       <li class="nav-item d-none d-sm-inline-block">
          <a class="nav-link" href="{{ route('client.show') }}">Client</a>
      </li>
      @endcan
      @can('user-reassign')
       <li class="nav-item d-none d-sm-inline-block">
          <a class="nav-link" href="{{ route('userassign.reassign') }}">Re-assign</a>
      </li>
      @endcan
      @can('user-reassign')
       <li class="nav-item d-none d-sm-inline-block">
          <a class="nav-link" href="{{ route('clientdashboard.generateentry') }}">Generate</a>
      </li>
      @endcan
       @can('user-reassign')
       <li class="nav-item d-none d-sm-inline-block">
...
<!--      @can('clientdashboard-show')
      <li class="nav-item d-none d-sm-inline-block">
          <a class="nav-link" href="{{ route('clientdashboard.show') }}">Client Board</a>
      </li>
      @endcan-->
...
<!--      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="{{ route('logout') }}" class="dropdown-item" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"> 2121
               <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
             Message Start 
