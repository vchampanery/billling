...
<!--datatable stop-->
    ...
    <script type="text/javascript">
        ...
        var vl = '{{$vl}}';
        var editrout = '{{ url('software/edit')}}';
        vArray.push(vl);
//            console.dir(vl);
        @endforeach
        console.dir(vArray);
    ...
    $(function () {
        var table = $('.data-table').DataTable(
        {
            ...
            columns: [
                ...
                {data: 'software_master_name', name: 'software_master_name'},
        ...
        columnDefs: [{
                ...
                'render': function (data, type, full, meta){
                     ...
                     return '<a href="'+editrout+'/'+full.software_master_id+'">'+data+'</a>';
