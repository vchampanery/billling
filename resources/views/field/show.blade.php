    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                ...
                <a class="btn btn-success" href="{{ route('field.create') }}"> Create New field</a>
...
//            console.dir(vl);
    ...
    $(function () {
        var table = $('.data-table').DataTable(
        {
            ...
            ajax: {
                "data": {"_token": ee},
                "url": "{{ route('field.show') }}",
                "type": "POST"
                
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'field_master_name', name: 'field_master_name'},
...
//                    console.dir("meta");
//                    console.dir(meta);
                     return '<a href="'+editrout+'/'+full.field_master_id+'">'+data+'</a>';
