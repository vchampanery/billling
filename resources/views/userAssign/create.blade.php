            ...
            <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3">
                    ...
                    <div class="input-group">
                        <select name="user_master_id" class="dropdown-primary md-form" multiple searchable="Search here..">
                ...
                <div class="col-xs-3 col-sm-3 col-md-3">
                    <strong></strong>                      
                    <div class="input-group">
                        <input type='text' class='form-control' id='' name='' value="" placeholder="Enter module name">
                    </div>
                </div>
            </div>
        </div>
