...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>User Assign Management</h2>
            </div>
            <div class="pull-right">
               
                <a class="btn btn-success" href="{{ route('userassign.create') }}"> Create New module</a>
...
<!--datatable stop-->
    ...
    <script type="text/javascript">
        ...
        var vl = '{{$vl}}';
        var editrout = '{{ url('userassign/edit')}}';
        vArray.push(vl);
//            console.dir(vl);
        @endforeach
        console.dir(vArray);
    ...
    $(function () {
        var table = $('.data-table').DataTable(
        {
            ...
            ajax: {
                "data": {"_token": ee},
                "url": "{{ route('userassign.show') }}",
                "type": "POST"
                
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'user_assign_master_id', name: 'user_assign_master_id'},
                {data: 'client_master_id', name: 'client_master_id'},
...
//                    console.dir("meta");
//                    console.dir(meta);
                     return '<a href="'+editrout+'/'+full.module_master_id+'">'+data+'</a>';
